...
# BLOCO PARA ESCONDER O MENU E O BOTÃO DE FORK/GITHUB
hide_style = """
    <style>
...
with col3:
    # ALTERAÇÃO AQUI: min_value mudado de 5.0 para 0.0 para aceitar qualquer valor
    ctc = st.number_input("CTC (cmolc/dm³)", 0.0, value=3.25)
    # ALTERAÇÃO AQUI: min_value para 0.0 para evitar bloqueios no PRNT
    prnt = st.number_input("PRNT (%)", 0.0, value=80.0)
...
obs_n = "Nitrogênio dispensado. Focar na inoculação." if cultura == "Soja" else "Aplicar nitrogênio conforme recomendação."
